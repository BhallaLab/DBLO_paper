## Specifically for this folder to calculate axial currents ###
    ...
    if vClamp:
        ...
        rdes = rd.rdesigneur(
            ...
            plotList=[
                ...
                ["dend0", "1", ".", "Vm", "dend0 Membrane potential MOOSE"],
            ],
        )
    else:
        rdes = rd.rdesigneur(
...
def runModel(
    ...
    if moose.exists("/model[0]/elec[0]/soma[0]/Ca_conc"):
        ...
        Vmvec_dend0 = moose.element("/model/graphs/plot3").vector
    else:
        Cavec = None
        Vmvec_dend0 = moose.element("/model/graphs/plot2").vector
    ...
    return [tvec, Ivec, Vmvec,Cavec, Vmvec_dend0]
