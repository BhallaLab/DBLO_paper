...
axO.scatter(np.array(Taum65_list)[np.argsort(DBLO_list)[0]]*1e3, np.array(DBLO_list)[np.argsort(DBLO_list)[0]]*1e3, s=50, c='C3', marker='X')
axO.scatter(np.array(Taum65_list)[np.argsort(DBLO_list)[-1]]*1e3, np.array(DBLO_list)[np.argsort(DBLO_list)[-1]]*1e3, s=50, c='C2', marker='X')
...
# axP.scatter(np.array(Taum65_list)[np.argsort(DBLO_list)[0]]*1e3/(np.array(maxtau_list)[np.argsort(DBLO_list)[0]]*1e3), np.array(DBLO_list)[np.argsort(DBLO_list)[0]]*1e3, s=50, c='C3', marker='X')
# axP.scatter(np.array(Taum65_list)[np.argsort(DBLO_list)[-1]]*1e3/(np.array(maxtau_list)[np.argsort(DBLO_list)[-1]]*1e3), np.array(DBLO_list)[np.argsort(DBLO_list)[-1]]*1e3, s=50, c='C2', marker='X')
