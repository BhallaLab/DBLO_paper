...
AP1thresh_list = np.array([a["Features"]["AP1_thresh_1.5e-10"] for a in basemodel_unified_list])
...
axA.text(13, -53, s=f'r = {np.corrcoef(DBLO_list*1e3, AP1thresh_list*1e3)[0][1]:.2f}')

#####################
sns.despine(fig=fig)
plt.tight_layout()
plt.savefig('SuppFigS3.png', dpi=300)
