    ...
    if vClamp:
        ...
        rdes = rd.rdesigneur(
            ...
            plotList=[
                ...
                ['soma', '1', '.', 'inject', 'Stimulus current'],
                ["soma", "1", "Ca_conc", "Ca", "Soma Calcium concentration"],
                ["soma", "1", "Na_T_Chan", "Gk", "Soma Na_T_Chan Gbar"],
                ["soma", "1", "Na_Chan", "Gk", "Soma Na_Chan Gbar"],
                ["soma", "1", "Na_T_Chan", "Y", "Soma Na Y"],
                ["soma", "1", "Na_Chan", "Y", "Soma Na Y"],
                # ["soma", "1", "K_A_Chan", "Gk", "Soma K_A_Chan Gbar"],
                # ["soma", "1", "K_DR_Chan", "Gk", "Soma K_DR_Chan Gbar"],
                ...
                # ["soma", "1", "Ca_L_Chan", "Ik", "Soma Ca_L_Chan current"],
                # ["soma", "1", ".", "Im", "Soma membrane current"],
                # ["soma", "1", "Na_T_Chan", "X", "Soma Na X"],
                # ["soma", "1", "Na_Chan", "X", "Soma Na X"],
...
def runModel(
    ...
    # Na_Chan_X_vec = moose.element("/model/graphs/plot3").vector
    Gk_Na_Chan_vec = moose.element("/model/graphs/plot2").vector
    Na_Chan_Y_vec = moose.element("/model/graphs/plot3").vector
    ...
    return [tvec, Ivec, Vmvec,Cavec, Gk_Na_Chan_vec, Na_Chan_Y_vec, I_K_DR_Chan_vec]
