...
#define nrn_init _nrn_init__Exp2i
#define _nrn_initial _nrn_initial__Exp2i
#define nrn_cur _nrn_cur__Exp2i
#define _nrn_current _nrn_current__Exp2i
#define nrn_jacob _nrn_jacob__Exp2i
#define nrn_state _nrn_state__Exp2i
#define _net_receive _net_receive__Exp2i 
#define state state__Exp2i 
...
#define DA _p[7]
#define DA_columnindex 7
#define DB _p[8]
#define DB_columnindex 8
#define _g _p[9]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 Exp2i /mnt/h/Thesis work/Compilations/ExistingModels/Combe2023/267599/cholinergic_shift_generalize/exp2i.mod\n");
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 69 in file exp2i.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/h/Thesis work/Compilations/ExistingModels/Combe2023/267599/cholinergic_shift_generalize/exp2i.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
