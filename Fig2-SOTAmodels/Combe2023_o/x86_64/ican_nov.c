...
#define nrn_init _nrn_init__icannov
#define _nrn_initial _nrn_initial__icannov
#define nrn_cur _nrn_cur__icannov
#define _nrn_current _nrn_current__icannov
#define nrn_jacob _nrn_jacob__icannov
#define nrn_state _nrn_state__icannov
#define _net_receive _net_receive__icannov 
#define evaluate_fct evaluate_fct__icannov 
#define states states__icannov 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_icannov", _hoc_setdata,
 "MyExp_icannov", _hoc_MyExp,
 "evaluate_fct_icannov", _hoc_evaluate_fct,
 0, 0
};
#define MyExp MyExp_icannov
 extern double MyExp( double );
 /* declare global and static user variables */
#define Kd Kd_icannov
 double Kd = 0.087;
 ...
 "taur_icannov", "ms",
 "erev_icannov", "mV",
 "gbar_icannov", "mho/cm2",
 "taumin_icannov", "ms",
 "can_icannov", "mM",
 "itrpm4_icannov", "mA/cm2",
 "jip3p_icannov", "mM/ms",
 0,0
};
 static double Po0 = 0;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "diam");
 	...
 	ivoc_help("help ?1 icannov /mnt/h/Thesis work/Compilations/ExistingModels/Combe2023/267599/cholinergic_shift_generalize/ican_nov.mod\n");
...
_deriv1_advance = 0;
 if(error){fprintf(stderr,"at line 64 in file ican_nov.mod:\n    SOLVE states METHOD derivimplicit\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 2; ++_i) {
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/h/Thesis work/Compilations/ExistingModels/Combe2023/267599/cholinergic_shift_generalize/ican_nov.mod";
static const char* nmodl_file_text = 
