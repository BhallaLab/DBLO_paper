...
#define cask _p[3]
#define cask_columnindex 3
#define ca _p[4]
#define ca_columnindex 4
#define Dca _p[5]
#define Dca_columnindex 5
#define ica _p[6]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "cvodeieq");
 	...
 	ivoc_help("help ?1 cad /mnt/h/Thesis work/Compilations/ExistingModels/Combe2023/267599/cholinergic_shift_generalize/cad.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) {int _reset = 0; {
   ...
   Dca = drive_channel / 18.0 + ( cainf - ca ) / ( taur ) ;
   cask = ca ;
   }
 return _reset;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/h/Thesis work/Compilations/ExistingModels/Combe2023/267599/cholinergic_shift_generalize/cad.mod";
static const char* nmodl_file_text = 
