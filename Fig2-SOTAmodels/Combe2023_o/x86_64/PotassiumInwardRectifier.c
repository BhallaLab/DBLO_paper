...
#define Offset _p[2]
#define Offset_columnindex 2
#define Slope _p[3]
#define Slope_columnindex 3
#define ik _p[4]
#define ik_columnindex 4
#define g _p[5]
#define g_columnindex 5
#define Dg _p[6]
#define Dg_columnindex 6
#define v _p[7]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _PotassiumInwardRectifier_reg() {
	int _vectorized = 1;
  _initlists();
 	ion_reg("k", -10000.);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "k_ion");
 	...
 	ivoc_help("help ?1 kir /mnt/h/Thesis work/Compilations/ExistingModels/Combe2023/267599/cholinergic_shift_generalize/PotassiumInwardRectifier.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Simplified KIR (Potassium Inward Rectifier)";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/h/Thesis work/Compilations/ExistingModels/Combe2023/267599/cholinergic_shift_generalize/PotassiumInwardRectifier.mod";
static const char* nmodl_file_text = 
