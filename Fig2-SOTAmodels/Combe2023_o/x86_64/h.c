...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 h /mnt/h/Thesis work/Compilations/ExistingModels/Combe2023/267599/cholinergic_shift_generalize/h.mod\n");
...
/*static int _ode_matsol1(_threadargsproto_);*/
 ...
 static int h(_threadargsproto_);
...
static int h (double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) {int _reset=0; int error = 0;
 ...
 error = nrn_newton_thread(_newtonspace1, 1,_slist2, _p, h, _dlist2, _ppvar, _thread, _nt);
...
{
 {  _deriv1_advance = 1;
 derivimplicit_thread(1, _slist1, _dlist1, _p, h, _ppvar, _thread, _nt);
_deriv1_advance = 0;
     if (secondorder) {
    int _i;
    for (_i = 0; _i < 1; ++_i) {
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/h/Thesis work/Compilations/ExistingModels/Combe2023/267599/cholinergic_shift_generalize/h.mod";
static const char* nmodl_file_text = 
  "TITLE  H-current\n"
