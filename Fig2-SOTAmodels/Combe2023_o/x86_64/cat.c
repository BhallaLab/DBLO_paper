...
#define h2 h2_cat
 ...
 extern double _f_betm( _threadargsprotocomma_ double );
 extern double _f_alpm( _threadargsprotocomma_ double );
 extern double _f_beth( _threadargsprotocomma_ double );
 extern double _f_alph( _threadargsprotocomma_ double );
...
static void _check_alph(double*, Datum*, Datum*, NrnThread*); 
static void _check_beth(double*, Datum*, Datum*, NrnThread*); 
static void _check_alpm(double*, Datum*, Datum*, NrnThread*); 
static void _check_betm(double*, Datum*, Datum*, NrnThread*); 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 cat /mnt/h/Thesis work/Compilations/ExistingModels/Combe2023/267599/cholinergic_shift_generalize/cat.mod\n");
...
/*static int _ode_matsol1(_threadargsproto_);*/
 static double _n_betm(_threadargsprotocomma_ double _lv);
 static double _n_alpm(_threadargsprotocomma_ double _lv);
 static double _n_beth(_threadargsprotocomma_ double _lv);
 static double _n_alph(_threadargsprotocomma_ double _lv);
...
static void _hoc_efun(void) {
 ...
 static double _mfac_alph, _tmin_alph;
  static void _check_alph(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) {
 ...
 double alph(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _lv) { 
#if 0
_check_alph(_p, _ppvar, _thread, _nt);
#endif
 ...
 static double _n_alph(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _lv){ int _i, _j;
 double _xi, _theta;
 if (!usetable) {
...
double _f_alph ( _threadargsprotocomma_ double _lv ) {
   double _lalph;
...
static void _hoc_alph(void) {
 ...
 static double _mfac_beth, _tmin_beth;
  static void _check_beth(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) {
  static int _maktable=1; int _i, _j, _ix = 0;
  double _xi, _tmax;
  if (!usetable) {return;}
  if (_maktable) { double _x, _dx; _maktable=0;
 ...
 double beth(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _lv) { 
#if 0
_check_beth(_p, _ppvar, _thread, _nt);
#endif
 ...
 static double _n_beth(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _lv){ int _i, _j;
 double _xi, _theta;
 if (!usetable) {
...
double _f_beth ( _threadargsprotocomma_ double _lv ) {
   double _lbeth;
...
static void _hoc_beth(void) {
 ...
 static double _mfac_alpm, _tmin_alpm;
  static void _check_alpm(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) {
  static int _maktable=1; int _i, _j, _ix = 0;
  double _xi, _tmax;
  if (!usetable) {return;}
  if (_maktable) { double _x, _dx; _maktable=0;
 ...
 double alpm(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _lv) { 
#if 0
_check_alpm(_p, _ppvar, _thread, _nt);
#endif
 ...
 static double _n_alpm(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _lv){ int _i, _j;
 double _xi, _theta;
 if (!usetable) {
...
double _f_alpm ( _threadargsprotocomma_ double _lv ) {
   double _lalpm;
...
static void _hoc_alpm(void) {
 ...
 static double _mfac_betm, _tmin_betm;
  static void _check_betm(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) {
  static int _maktable=1; int _i, _j, _ix = 0;
  double _xi, _tmax;
  if (!usetable) {return;}
  if (_maktable) { double _x, _dx; _maktable=0;
 ...
 double betm(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _lv) { 
#if 0
_check_betm(_p, _ppvar, _thread, _nt);
#endif
 ...
 static double _n_betm(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _lv){ int _i, _j;
 double _xi, _theta;
 if (!usetable) {
...
double _f_betm ( _threadargsprotocomma_ double _lv ) {
   double _lbetm;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/h/Thesis work/Compilations/ExistingModels/Combe2023/267599/cholinergic_shift_generalize/cat.mod";
static const char* nmodl_file_text = 
