...
#define nrn_init _nrn_init__nmdanet
#define _nrn_initial _nrn_initial__nmdanet
#define nrn_cur _nrn_cur__nmdanet
#define _nrn_current _nrn_current__nmdanet
#define nrn_jacob _nrn_jacob__nmdanet
#define nrn_state _nrn_state__nmdanet
#define _net_receive _net_receive__nmdanet 
#define release release__nmdanet 
...
#define _f_mgblock _f_mgblock_nmdanet
#define mgblock mgblock_nmdanet
 extern double _f_mgblock( double );
 extern double mgblock( double );
 /* declare global and static user variables */
#define Cdur Cdur_nmdanet
 double Cdur = 1;
#define Erev Erev_nmdanet
 double Erev = 0;
#define Rtau Rtau_nmdanet
 double Rtau = 0;
#define Rinf Rinf_nmdanet
 double Rinf = 0;
#define usetable usetable_nmdanet
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_nmdanet", 0, 1,
 0,0,0
};
 ...
 "Cdur_nmdanet", &Cdur_nmdanet,
 "Erev_nmdanet", &Erev_nmdanet,
 "Rinf_nmdanet", &Rinf_nmdanet,
 "Rtau_nmdanet", &Rtau_nmdanet,
 "usetable_nmdanet", &usetable_nmdanet,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 nmdanet /mnt/h/Thesis work/Compilations/ExistingModels/Combe2023/267599/cholinergic_shift_generalize/nmdanet.mod\n");
...
static double _nrn_current(double _v){double _current=0.;v=_v;{ {
   g = mgblock ( _threadargscomma_ v ) * ( Ron + Roff ) * 1.0 ;
   i = g * ( v - Erev ) ;
   }
 _current += i;
...
{
 { error =  release();
 if(error){fprintf(stderr,"at line 97 in file nmdanet.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/h/Thesis work/Compilations/ExistingModels/Combe2023/267599/cholinergic_shift_generalize/nmdanet.mod";
static const char* nmodl_file_text = 
