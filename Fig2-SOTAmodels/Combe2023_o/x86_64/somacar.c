...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 somacar /mnt/h/Thesis work/Compilations/ExistingModels/Combe2023/267599/cholinergic_shift_generalize/somacar.mod\n");
...
double varss ( _threadargsprotocomma_ double _lv , double _li ) {
   double _lvarss;
 if ( _li  == 0.0 ) {
     _lvarss = 1.0 / ( 1.0 + MyExp ( _threadargscomma_ ( _lv + 60.0 ) / ( - 3.0 ) ) ) ;
     }
   else if ( _li  == 1.0 ) {
     _lvarss = 1.0 / ( 1.0 + MyExp ( _threadargscomma_ ( _lv + 62.0 ) / ( 1.0 ) ) ) ;
     }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/h/Thesis work/Compilations/ExistingModels/Combe2023/267599/cholinergic_shift_generalize/somacar.mod";
static const char* nmodl_file_text = 
  "\n"
  ...
  "	if (i==0) {\n"
  "	   varss = 1 / (1 + MyExp((v+60)/(-3))) :Ca activation\n"
  "	}\n"
  "	else if (i==1) {\n"
  "           varss = 1/ (1 + MyExp((v+62)/(1)))   :Ca inactivation\n"
  "	}\n"
  "}\n"
  "\n"
  "FUNCTION vartau(i) {\n"
