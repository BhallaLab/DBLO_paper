...
#define gcal _p[1]
#define gcal_columnindex 1
#define ica _p[2]
#define ica_columnindex 2
#define inf (_p + 3)
#define inf_columnindex 3
#define tau (_p + 5)
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 calH /mnt/h/Thesis work/Compilations/ExistingModels/Combe2023/267599/cholinergic_shift_generalize/calH.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/h/Thesis work/Compilations/ExistingModels/Combe2023/267599/cholinergic_shift_generalize/calH.mod";
static const char* nmodl_file_text = 
