...
static void nrn_alloc(Prop* _prop) {
 ...
 prop_ion = need_memb(_morphology_sym);
 	_ppvar[0]._pval = &prop_ion->param[0]; /* diam */
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "diam");
 	...
 	ivoc_help("help ?1 icand /mnt/h/Thesis work/Compilations/ExistingModels/Combe2023/267599/cholinergic_shift_generalize/icand.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/h/Thesis work/Compilations/ExistingModels/Combe2023/267599/cholinergic_shift_generalize/icand.mod";
static const char* nmodl_file_text = 
