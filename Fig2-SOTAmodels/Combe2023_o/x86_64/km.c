...
#define rate rate__km 
#define state state__km 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 km /mnt/h/Thesis work/Compilations/ExistingModels/Combe2023/267599/cholinergic_shift_generalize/km.mod\n");
...
double bett (  double _lv ) {
   double _lbett;
 double _lArg ;
 _lArg = 0.0378 * zetat * gmt * ( _lv - vhalft ) ;
   if ( _lArg < - 50.0 ) {
     _lbett = 0.0 ;
     }
   else if ( _lArg > 50.0 ) {
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  state();
 if(error){fprintf(stderr,"at line 59 in file km.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/h/Thesis work/Compilations/ExistingModels/Combe2023/267599/cholinergic_shift_generalize/km.mod";
static const char* nmodl_file_text = 
