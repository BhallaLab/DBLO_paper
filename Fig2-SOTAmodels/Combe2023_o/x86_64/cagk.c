...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 mykca /mnt/h/Thesis work/Compilations/ExistingModels/Combe2023/267599/cholinergic_shift_generalize/cagk.mod\n");
...
double exp1 (  double _lk , double _ld , double _lv ) {
   double _lexp1;
 _lexp1 = _lk * MyExp ( _threadargscomma_ - 2.0 * _ld * FARADAY * _lv / R / ( 273.15 + celsius ) ) ;
 ...
 t = 0.0;
{
  o = o0;
 {
   rate ( _threadargscomma_ v , cainit ) ;
   o = oinf ;
   }
 ...
 v=_v;
{
  ...
  cai = _ion_cai;
 { error =  state();
 if(error){fprintf(stderr,"at line 74 in file cagk.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/h/Thesis work/Compilations/ExistingModels/Combe2023/267599/cholinergic_shift_generalize/cagk.mod";
static const char* nmodl_file_text = 
  "TITLE CaGk\n"
