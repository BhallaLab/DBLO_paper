...
#define dt _nt->_dt
#define cainit _p[0]
#define cainit_columnindex 0
#define gbar _p[1]
#define gbar_columnindex 1
#define cac _p[2]
#define cac_columnindex 2
#define gk _p[3]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 kca /mnt/h/Thesis work/Compilations/ExistingModels/Combe2023/267599/cholinergic_shift_generalize/kca.mod\n");
...
static void initmodel(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) {
  ...
  m = m0;
 {
   ...
   evaluate_fct ( _threadargscomma_ v , cainit ) ;
   m = m_inf ;
   }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/h/Thesis work/Compilations/ExistingModels/Combe2023/267599/cholinergic_shift_generalize/kca.mod";
static const char* nmodl_file_text = 
