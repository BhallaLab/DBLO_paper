...
for Cachan in ['CaL', 'CaN', 'CaR', 'CaT']:
    ...
    Multiprocessthis_appendsave(ourfunc, basemodel_imp_list, [], [f'{Cachan}/i.pkl', f'{Cachan}/tvec.pkl', f'{Cachan}/Vmvec.pkl', f'{Cachan}/Cavec.pkl', f'{Cachan}/I_Ca_L_Chan_vec.pkl', f'{Cachan}/I_Ca_N_Chan_vec.pkl', f'{Cachan}/I_Ca_R_Chan_vec.pkl', f'{Cachan}/I_Ca_T_Chan_vec.pkl'], seed=123, npool=110)
